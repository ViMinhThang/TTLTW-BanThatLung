                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <tbody>
                                <c:forEach var="user" items="${userPermissionViews}">
                                    <tr>
                                        <td>${user.userid}</td>
                                        <td>${user.userEmail}</td>
                                        <td>
                                            <c:forEach var="res" items="${user.resources}">
                                                ${res}<br/>
                                            </c:forEach>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <c:if test="${user.groupName ne 'admin'}">
                                                <form class="pb-3" action="/admin/table/permission" method="POST">
                                                    <input type="hidden" name="message" value="promote"/>
                                                    <input type="hidden" name="userId" value="${user.userid}"/>
                                                    <button type="submit" class="btn btn-primary">Thăng quyền</button>
                                                </form>
                                            </c:if>

                                            <c:if test="${user.groupName ne 'viewer'}">
                                                <form action="/admin/table/permission" method="POST">
                                                    <input type="hidden" name="message" value="demote"/>
                                                    <input type="hidden" name="userId" value="${user.userid}"/>
                                                    <button type="submit" class="btn btn-primary">Hạ quyền</button>
                                                </form>
                                            </c:if>
