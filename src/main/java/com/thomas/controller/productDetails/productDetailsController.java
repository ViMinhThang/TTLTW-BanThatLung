...
//            b.getBeltVariants().forEach(v -> v.setImage(productService.getVariantImages(v.getId())));
//        }
...
//
//        List<BeltVariant> similarVariants = productService.findVariants(null, v.getColorId(), v.getSizeId(), null);
//
//        List<BeltVariant> SimilarVariantColor = productService.findVariants(null, v.getColorId(), null, null);
